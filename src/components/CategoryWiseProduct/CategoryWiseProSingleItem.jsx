...
const CategoryWiseProSingleItem = ({ item }) => {
  return (
    <div class="inner-product-main-flex splide__slide">
          ...
          <div class="add-tocart-overlay">
            <div class="inner-card-flex">
              <div class="qty-holder2">
                <span onclick="inc()" class="qty-dec-btn2" title="Dec">
                  -
                </span>
                <aside>1 Item Add</aside>
                <span onclick="dec()" class="qty-inc-btn2" title="Inc">
                  +
                </span>
              </div>
            </div>
...
export default CategoryWiseProSingleItem;
